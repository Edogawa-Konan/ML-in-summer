...
"""
    ...
    3) should work, run it with:
        THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python3.5 my_test.py
...
# ----------------------
# - network3.py example:
from Deeplearning.network3 import Network, load_data_shared,ConvPoolLayer, FullyConnectedLayer, SoftmaxLayer # softmax plus log-likelihood cost is more common in modern image classification networks.
